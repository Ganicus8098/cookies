 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".cookie-coll__slider")) new swiper_core_Swiper(".cookie-coll__slider", {
                ...
                pagination: {
                    el: ".cookie-coll__dotts-pagination",
                    clickable: true,
                ...
                navigation: {
                    prevEl: ".cookie-coll__arrow--left",
                    nextEl: ".cookie-coll__arrow--right"
                },
                on: {}
            });
        }
